...
const SettingMenu = () => {
  return (
    <Menu as="div">
      ...
      >
        <Menu.Items className="absolute w-56 mt-1 bg-white divide-y divide-gray-100 rounded-md shadow-lg dark:bg-slate-600 ring-1 ring-black ring-opacity-5 focus:outline-none">
